...
const en: Dictionary = {
  ...
  about: {
    heading: "About",
    paragraphs: [
      "Backend developer focused on Java/Spring Boot and Python/Django, designing architectures, databases and APIs for systems built to last. I have hands-on experience with real projects — from social-impact platforms to systems running in real production — always with a security-first mindset and well-designed code.",
    ],
...
const es: Dictionary = {
  ...
  about: {
    heading: "Sobre mí",
    paragraphs: [
      "Desarrollador backend enfocado en Java/Spring Boot y Python/Django, diseñando arquitecturas, bases de datos y APIs para sistemas hechos para durar. Tengo experiencia práctica con proyectos reales — desde plataformas de impacto social hasta sistemas en producción real — siempre con una mentalidad orientada a la seguridad y al código bien diseñado.",
    ],
    skillsHeading: "Habilidades",

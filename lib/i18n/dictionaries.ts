  ...
  hero: {
    ...
    terminal: {
      ...
      fields: [
        ...
        { name: "domain", value: "fiscal · farmacêutico" },
      ],
  ...
  hero: {
    ...
    terminal: {
      ...
      fields: [
        { name: "stack", value: "Java + Spring Boot" },
        { name: "focus", value: "multi-tenant" },
        { name: "domain", value: "billing · pharma" },
      ],
      result: "deploy --confidence",
    },
  },
  ...
  hero: {
    ...
    terminal: {
      ...
      fields: [
        { name: "stack", value: "Java + Spring Boot" },
        { name: "focus", value: "multi-tenant" },
        { name: "domain", value: "fiscal · farmacéutico" },
      ],
      result: "deploy --confidence",
    },
  },
